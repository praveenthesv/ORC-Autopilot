...
def calculate_score(
    ...
    if education_required and normalize_degree(education_required) in normalize_degree(candidate_education):
        score += 10
...
def evaluate_candidate():
    try:
        ...
        auto_approve_score = float(data.get('auto_approve_score', 80) or 80)
        review_score = float(data.get('review_score', 60) or 60)
